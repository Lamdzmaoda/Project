...
/**
 * Class dùng chung để bao bọc mọi phản hồi từ API (Standard API Response).
 * Giúp Frontend luôn nhận được một cấu trúc dữ liệu nhất quán.
...
@Builder // Hỗ trợ khởi tạo đối tượng theo pattern Builder (ví dụ: ApiResponse.builder().code(1000).build())
@NoArgsConstructor // Tạo constructor không tham số (cần thiết cho Jackson để chuyển JSON sang Object)
...
@JsonInclude(JsonInclude.Include.NON_NULL) // Chỉ render ra JSON những trường nào có giá trị (trường null sẽ bị ẩn đi)
