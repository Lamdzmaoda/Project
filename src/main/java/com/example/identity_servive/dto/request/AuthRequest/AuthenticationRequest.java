...
/**
 * Class đại diện cho yêu cầu xác thực (đăng nhập) từ Client gửi lên. Chứa các thông tin cần thiết
 * để hệ thống nhận diện người dùng.
 */
...
@FieldDefaults(
    level = AccessLevel.PRIVATE) // Tự động đặt tất cả các field là 'private' (theo chuẩn đóng gói)
