...
/**
 * Class đại diện cho dữ liệu người dùng trả về cho Client.
 * Giúp kiểm soát những thông tin nào được phép hiển thị ra bên ngoài.
 */
@Data // Tự động tạo Getter, Setter, toString, equals, hashCode
@NoArgsConstructor // Tạo constructor không tham số (Bắt buộc cho Jackson để chuyển Object sang JSON)
...
public class UserResponse {
    ...
    /**
     * CẢNH BÁO BẢO MẬT:
     * Thông thường, chúng ta KHÔNG BAO GIỜ trả về trường 'password' trong UserResponse.
     * Ngay cả khi mật khẩu đã được mã hóa, việc gửi nó về Client là một kẽ hở bảo mật.
     */
