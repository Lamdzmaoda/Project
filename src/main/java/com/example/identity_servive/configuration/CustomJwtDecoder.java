...
public class CustomJwtDecoder implements JwtDecoder {
    ...
    @Autowired private AuthenticationService authenticationService; // Tiêm Service để gọi logic kiểm tra Token

    private NimbusJwtDecoder nimbusJwtDecoder = null; // Đối tượng dùng để giải mã JWT theo chuẩn Nimbus
