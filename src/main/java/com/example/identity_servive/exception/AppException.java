...
/**
 * Ngoại lệ tùy chỉnh cho ứng dụng (Custom Application Exception).
 * Dùng để ném ra (throw) khi có lỗi nghiệp vụ xảy ra (ví dụ: User không tồn tại, Sai mật khẩu).
 * Kế thừa từ RuntimeException để không bắt buộc phải try-catch mọi nơi.
 */
