...
public interface UserMapper {
    ...
    /**
     * Chuyển đổi từ thực thể (Entity) sang dữ liệu phản hồi (DTO) gửi về cho Client.
     * @Mapping(target = "lastName", ignore = true): Chỉ định MapStruct bỏ qua trường lastName.
     * Khi trả về Client, trường lastName trong UserResponse sẽ luôn là null.
     */
     ...
     * @param user Đối tượng User gốc lấy từ DB.
     * @MappingTarget: Đánh dấu đây là đối tượng đích sẽ được ghi đè dữ liệu lên.
     */
