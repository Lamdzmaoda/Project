...
public class PostService {
    ...
    private PostResponse buildPostResponse(Post post, String currentUserId) {
        ...
        if (currentUserId != null) {
            response.setLikedByMe(postLikeRepository.existsByPostIdAndUserId(post.getId(), currentUserId));
            response.setSavedByMe(savedPostRepository.existsByUserIdAndPostId(currentUserId, post.getId()));
        }
        return response;
    }
}
