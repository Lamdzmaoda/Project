...
public interface UserLessonProgressRepository extends JpaRepository<UserLessonProgress, String> {
    ...
    int countByUserAndLesson_ChapterAndCompletedStatus(User user, Chapter chapter, IsCompleted completedStatus);
    void deleteAllByLessonId(String lessonId);
    int countByUserAndLesson_Chapter_LanguageAndCompletedStatus(User user, Language language, IsCompleted status);
