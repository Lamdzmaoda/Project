...
@FieldDefaults(
    ...
    makeFinal = true) // Tự động thêm 'private final' cho các field
public class RoleController {
  ...
  ApiResponse<RoleRespone> create(@RequestBody RoleRequest request) {
    ...
    return ApiResponse.<RoleRespone>builder().result(roleService.create(request)).build();
  }
  ...
  ApiResponse<List<RoleRespone>> getAll() {
    ...
    return ApiResponse.<List<RoleRespone>>builder().result(roleService.getAll()).build();
  }
