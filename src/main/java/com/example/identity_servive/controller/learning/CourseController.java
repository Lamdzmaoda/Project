...
public class CourseController {
    ...
    ApiResponse<StepResponse> updateStep(@RequestBody StepUpdateRequest request, @PathVariable("stepsId") String stepsId) {
        return ApiResponse.<StepResponse>builder()
                .result(courseService.updateStep(stepsId, request))
                .build();
    }
    @PutMapping("/problems/{problemId}")
    ApiResponse<ProblemResponse> updateProblem(@RequestBody ProblemUpdateRequest request, @PathVariable("problemId") String problemId) {
        return ApiResponse.<ProblemResponse>builder()
                .result(courseService.updateProblem(problemId, request))
                .build();
    }
    @PutMapping("/lessons/{lessonId}")
    ApiResponse<LessonResponse> updateLesson(@RequestBody LessonUpdateRequest request, @PathVariable("lessonId") String lessonId) {
        return ApiResponse.<LessonResponse>builder()
                .result(courseService.updateLesson(lessonId, request))
                .build();
    }
    @PutMapping("/chapters/{chapterId}")
    ApiResponse<ChapterResponse> updateChapter(@RequestBody ChapterUpdateRequest request, @PathVariable("chapterId") String chapterId) {
        return ApiResponse.<ChapterResponse>builder()
                .result(courseService.updateChapter(chapterId, request))
                .build();
    }
    @PutMapping("/languages/{languageName}")
    ApiResponse<LanguageResponse> updateLanguage(@RequestBody LanguageUpdateRequest request, @PathVariable("languageName") String languageName) {
        return ApiResponse.<LanguageResponse>builder()
    ...
    ApiResponse<StepResponse> getStep(@PathVariable("stepId") String stepId){
        return ApiResponse.<StepResponse>builder()
                .result(courseService.getStepById(stepId))
                .build();
    }
