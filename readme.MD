...
## Docker guideline
### Build docker image
`docker build -t lamdzbodoi/lamdzbodoi:0.0.3 .`
### Push docker image to Docker Hub
`docker image push lamdzbodoi/lamdzbodoi:0.0.3`
### Create network:
...
`docker run --name lamdzbodoi `
--network devteria-network `
  -p 8080:8080 `
-e SPRING_DATASOURCE_URL=jdbc:mysql://mysql:3306/identity-servive `
